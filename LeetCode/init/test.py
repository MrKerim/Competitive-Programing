...
def get_inputs():
    ...
    def start_signal_checker():
        ...
        def signal_loop():
            while True:
                print("Signal checker running...")
                #connection_status.config(text=measure_signal_strength(), fg="green")
                root.after(0, update_canvas(measure_signal_strength()))
                print("Signal strength:", measure_signal_strength())
                time.sleep(5)
